...
} from '../new-artist-dialog/new-artist-dialog.component';
...
export class ArtistsListComponent implements OnInit {
  ...
  onClick(artist: Artist): void {
    this.router
      .navigate([artist.id], { relativeTo: this.route })
  ...
  onNewArtist(): void {
    ...
    dlg.afterClosed().subscribe((data: NewArtistData) => {
      if (data) {
        this.service.addArtist(data.name, data.image).catch(console.log);
      }
    });
  }
}
